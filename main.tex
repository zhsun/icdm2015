...
%% \label{sec:archi}
%% This section explains how we implement our {\sppan} model and deploy
%% into Google's Adsense system.  \textcolor{red} {add one architecture
%%   photo, add some description about how does the systme work}
